...
namespace Testv30
{
    class IMFRealTimeClientExTest : COMBase, IMFSampleGrabberSinkCallback, IMFAsyncCallback
    {
        int WORKQUEUE_ID;
    ...
    public class TestThing : COMBase, IMFTransform, IDisposable, IMFRealTimeClientEx
    {
